...
This agent supports a vararity of frameworks but can also be used with your custom stack.'
  ...
  commands: `// ${_i18n.i18n.translate('xpack.apm.tutorial.nodeClient.configure.commands.addThisToTheFileTopComment', {
...
var apm = require('elastic-apm-node').start({curlyOpen}
  // ${_i18n.i18n.translate('xpack.apm.tutorial.nodeClient.configure.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Override service name from package.json'
  })}
  // ${_i18n.i18n.translate('xpack.apm.tutorial.nodeClient.configure.commands.allowedCharactersComment', {
    defaultMessage: 'Allowed characters: a-z, A-Z, 0-9, -, _, and space'
  })}
  serviceName: '',

  // ${_i18n.i18n.translate('xpack.apm.tutorial.nodeClient.configure.commands.useIfApmRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a token'
  })}
  secretToken: '${secretToken}',

  // ${_i18n.i18n.translate('xpack.apm.tutorial.nodeClient.configure.commands.setCustomApmServerUrlComment', {
...
APM services are created programmatically based on the `SERVICE_NAME`.'
  ...
  commands: `# ${_i18n.i18n.translate('xpack.apm.tutorial.djangoClient.configure.commands.addAgentComment', {
...
ELASTIC_APM = {curlyOpen}
  # ${_i18n.i18n.translate('xpack.apm.tutorial.djangoClient.configure.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Set required service name. Allowed characters:'
  })}
  # ${_i18n.i18n.translate('xpack.apm.tutorial.djangoClient.configure.commands.allowedCharactersComment', {
    defaultMessage: 'a-z, A-Z, 0-9, -, _, and space'
  })}
  'SERVICE_NAME': '',

  # ${_i18n.i18n.translate('xpack.apm.tutorial.djangoClient.configure.commands.useIfApmServerRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a token'
  })}
  'SECRET_TOKEN': '${secretToken}',

  # ${_i18n.i18n.translate('xpack.apm.tutorial.djangoClient.configure.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
    values: {
      defaultApmServerUrl: 'http://localhost:8200'
    }
...
# ${_i18n.i18n.translate('xpack.apm.tutorial.djangoClient.configure.commands.addTracingMiddlewareComment', {
...
APM services are created programmatically based on the `SERVICE_NAME`.'
  ...
  commands: `# ${_i18n.i18n.translate('xpack.apm.tutorial.flaskClient.configure.commands.initializeUsingEnvironmentVariablesComment', {
...
app.config['ELASTIC_APM'] = {curlyOpen}
  # ${_i18n.i18n.translate('xpack.apm.tutorial.flaskClient.configure.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Set required service name. Allowed characters:'
  })}
  # ${_i18n.i18n.translate('xpack.apm.tutorial.flaskClient.configure.commands.allowedCharactersComment', {
    defaultMessage: 'a-z, A-Z, 0-9, -, _, and space'
  })}
  'SERVICE_NAME': '',

  # ${_i18n.i18n.translate('xpack.apm.tutorial.flaskClient.configure.commands.useIfApmServerRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a token'
  })}
  'SECRET_TOKEN': '${secretToken}',

  # ${_i18n.i18n.translate('xpack.apm.tutorial.flaskClient.configure.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
    values: {
      defaultApmServerUrl: 'http://localhost:8200'
    }
...
# ${_i18n.i18n.translate('xpack.apm.tutorial.rackClient.createConfig.commands.setServiceNameComment', {
    defaultMessage: 'Set service name - allowed characters: a-z, A-Z, 0-9, -, _ and space'
  })}
# ${_i18n.i18n.translate('xpack.apm.tutorial.rackClient.createConfig.commands.defaultsToTheNameOfRackAppClassComment', {
    defaultMessage: "Defaults to the name of your Rack app's class."
  })}
# service_name: 'my-service'

# ${_i18n.i18n.translate('xpack.apm.tutorial.rackClient.createConfig.commands.useIfApmServerRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a token'
  })}
# secret_token: '${secretToken}'

# ${_i18n.i18n.translate('xpack.apm.tutorial.rackClient.createConfig.commands.setCustomApmServerComment', {
...
var apm = initApm({curlyOpen}
  ...
  // ${_i18n.i18n.translate('xpack.apm.tutorial.jsClient.installDependency.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Set required service name (allowed characters: a-z, A-Z, 0-9, -, _, and space)'
  })}
  serviceName: '',

  // ${_i18n.i18n.translate('xpack.apm.tutorial.jsClient.installDependency.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
    values: {
      defaultApmServerUrl: 'http://localhost:8200'
    }
  ...
  // ${_i18n.i18n.translate('xpack.apm.tutorial.jsClient.installDependency.commands.setServiceVersionComment', {
...
file name, or the `ELASTIC_APM_SERVICE_NAME` environment variable.'
  ...
  commands: `# ${_i18n.i18n.translate('xpack.apm.tutorial.goClient.configure.commands.initializeUsingEnvironmentVariablesComment', {
    defaultMessage: 'Initialize using environment variables:'
  })}

# ${_i18n.i18n.translate('xpack.apm.tutorial.goClient.configure.commands.setServiceNameComment', {
    defaultMessage: 'Set the service name. Allowed characters: # a-z, A-Z, 0-9, -, _, and space.'
  })}
# ${_i18n.i18n.translate('xpack.apm.tutorial.goClient.configure.commands.usedExecutableNameComment', {
    defaultMessage: 'If ELASTIC_APM_SERVICE_NAME is not specified, the executable name will be used.'
  })}
export ELASTIC_APM_SERVICE_NAME=

# ${_i18n.i18n.translate('xpack.apm.tutorial.goClient.configure.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
    values: {
      defaultApmServerUrl: 'http://localhost:8200'
    }
...
# ${_i18n.i18n.translate('xpack.apm.tutorial.goClient.configure.commands.useIfApmRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a token'
  })}
